...
public class MaximumSubarray {
    ...
    private static <T extends Number> ThreeTuple<Integer, Integer, Double> findMaxCrossingSubarray(T[] A, int low, int mid, int high) {
    ...
    private static <T extends Number> ThreeTuple<Integer, Integer, Double> findMaximumSubarray(T[] A, int low, int high) {
    ...
    public static <T extends Number> ThreeTuple<Integer, Integer, Double> findMaximumSubarray(T[] A) {
